...
export default function GeneralLessonsTrainingPage() {
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="aspect-video bg-black overflow-hidden order-2 lg:order-1">
              <iframe
                ...
                title="Welcome to Info & Education Training"
                allow="autoplay; fullscreen"
                frameBorder="0"
                className="w-full h-full"
              />
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="font-display text-[clamp(1.75rem,4vw,2.5rem)] font-black text-black leading-tight mb-6">
                Welcome to Info & Education Training
              </h2>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-black/60 leading-relaxed mb-10">
              Join our community to share strategies with other course creators and coaches,
