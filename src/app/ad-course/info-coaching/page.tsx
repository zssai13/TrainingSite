...
const lessons = [
  {
    ...
    videoId: 'drhan93ocz',
    problem: [
      'Info product and coaching funnels have unique attribution challenges',
      'Long sales cycles with webinars, VSLs, and applications are hard to track',
      'You need strategies that work specifically for high-ticket offers',
    ],
    solution:
      'Get an up-to-date breakdown of what\'s working right now for info product creators and coaches. This lesson covers the latest funnel tracking strategies, application attribution, and how to handle complex multi-step sales processes.',
    docsUrl: 'https://docs.hyros.com/info-coaching-2026/',
    docsLabel: 'Info/Coaching 2026 Guide',
  },
  {
    id: 2,
    number: '02',
    title: 'Easiest Attribution Wins',
    duration: '6 min',
    videoId: 'drhan93ocz',
    problem: [
      'You want quick wins that work with course platforms and coaching funnels',
      'Complex webinar and application tracking feels overwhelming',
      'You need to demonstrate ROI quickly before diving deeper',
    ],
    solution:
      'Learn the low-hanging fruit of info product attribution. These quick implementations work with ClickFunnels, Kajabi, Teachable, and other course platforms. Get results within days, not weeks.',
    docsUrl: 'https://docs.hyros.com/quick-wins-info/',
    docsLabel: 'Quick Wins Guide',
  },
  {
    id: 3,
    number: '03',
    title: 'Advanced Attribution Tactics',
    duration: '10 min',
    videoId: 'drhan93ocz',
    problem: [
      'Basic attribution is set up but you want to go further',
      'You need to track the full journey from ad to application to sale',
      'You want to optimize for high-ticket clients, not just leads',
    ],
    solution:
      'Dive deep into advanced info product attribution including webinar tracking, application funnel optimization, and high-ticket client acquisition. Learn to identify which traffic sources produce buyers, not just registrants.',
    docsUrl: 'https://docs.hyros.com/advanced-info/',
...
export default function InfoCoachingPage() {
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="aspect-video bg-black overflow-hidden order-2 lg:order-1">
              <iframe
                ...
                title="Welcome to Info/Coaching Training"
                allow="autoplay; fullscreen"
                frameBorder="0"
                className="w-full h-full"
              />
            ...
            <div className="order-1 lg:order-2">
              <p className="text-[13px] uppercase tracking-[0.2em] text-black/40 mb-4">
                Info/Coaching Module
              </p>
              <h2 className="font-display text-[clamp(1.75rem,4vw,2.5rem)] font-black text-black leading-tight mb-6">
                Info & Coaching Attribution
              </h2>
              <p className="text-black/60 leading-relaxed mb-6">
                Attribution tactics tailored for course creators and coaches.
                Learn how to track complex funnels and optimize for high-ticket sales.
              </p>
              <p className="text-black/60 leading-relaxed">
                These lessons are designed specifically for info product businesses
                running webinars, VSLs, and application funnels.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-black/60 leading-relaxed mb-10">
              Check out the SaaS/B2B module for subscription business tactics,
