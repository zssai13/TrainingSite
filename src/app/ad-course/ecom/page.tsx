...
const lessons = [
  {
    ...
    videoId: 'drhan93ocz',
    problem: [
      'E-commerce attribution has changed dramatically with iOS updates and cookie deprecation',
      'Strategies that worked in 2023 are no longer effective',
      'You need to know which tactics are currently delivering results',
    ],
    solution:
      'Get an up-to-date breakdown of what\'s working right now for e-commerce advertisers. This lesson covers the latest platform changes, attribution models, and strategies that top DTC brands are using to maintain profitability.',
    docsUrl: 'https://docs.hyros.com/ecommerce-2026/',
    docsLabel: 'E-Commerce 2026 Guide',
  },
  {
    id: 2,
    number: '02',
    ...
    videoId: 'drhan93ocz',
    problem: [
      'You want quick wins but don\'t know where to start',
      'Complex attribution setups feel overwhelming',
      'You need to show ROI fast to justify the investment',
    ],
    solution:
      'Learn the low-hanging fruit of e-commerce attribution. These quick implementations can boost your ROAS within days, not weeks. Perfect for getting started or demonstrating value before diving deeper.',
    docsUrl: 'https://docs.hyros.com/quick-wins-ecom/',
  ...
  },
  {
    ...
    problem: [
      ...
      'You\'re ready to implement sophisticated multi-touch models',
      'You need to handle complex customer journeys with multiple touchpoints',
    ],
    solution:
      'Dive deep into advanced e-commerce attribution strategies including multi-touch modeling, cohort analysis, and predictive LTV. These tactics separate the top 1% of e-commerce advertisers from everyone else.',
    docsUrl: 'https://docs.hyros.com/advanced-ecom/',
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-black/60 leading-relaxed mb-6">
                Industry-specific strategies for e-commerce attribution in 2026.
                Learn what&apos;s working now and how to implement it in your DTC business.
              </p>
              <p className="text-black/60 leading-relaxed">
                These lessons are designed specifically for e-commerce advertisers
                running Shopify, WooCommerce, or custom storefronts.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-black/60 leading-relaxed mb-10">
              Check out the Info/Coaching or SaaS modules for industry-specific tactics,
