...
const lessons = [
  {
    ...
    videoId: 'drhan93ocz',
    problem: [
      'SaaS and B2B have long sales cycles that break traditional attribution',
      'Trials, demos, and enterprise sales involve multiple touchpoints',
      'You need strategies that account for MRR and ARR, not just one-time purchases',
    ],
    solution:
  ...
  },
  {
    ...
    videoId: 'drhan93ocz',
    problem: [
      'You want quick wins that work with subscription billing platforms',
      'Complex trial-to-paid tracking feels overwhelming',
      'You need to demonstrate ROI quickly with MRR metrics',
    ],
    solution:
  ...
  },
  {
    ...
    problem: [
      ...
      'You need to track the full journey from ad to trial to paid to expansion',
      'You want to optimize for LTV and reduce churn through better targeting',
    ],
    solution:
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="aspect-video bg-black overflow-hidden order-2 lg:order-1">
              <iframe
                ...
                title="Welcome to SaaS/B2B Training"
                allow="autoplay; fullscreen"
                frameBorder="0"
                className="w-full h-full"
              />
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="font-display text-[clamp(1.75rem,4vw,2.5rem)] font-black text-black leading-tight mb-6">
                SaaS & B2B Attribution
              </h2>
              <p className="text-black/60 leading-relaxed mb-6">
                Enterprise-focused attribution for subscription and B2B businesses.
                Learn how to track MRR, trials, and long sales cycles accurately.
              </p>
              <p className="text-black/60 leading-relaxed">
                These lessons are designed specifically for SaaS companies and B2B
                advertisers with complex sales processes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-black/60 leading-relaxed mb-10">
              You&apos;ve completed all the modules. Return to the course overview to
              revisit any lessons or explore the documentation for deeper implementation guides.
            </p>
